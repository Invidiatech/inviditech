        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 mb-4">
                    <h6 class="text-white mb-4">Subscribe to Our Newsletter</h6>
                    <p class="text-white-50">Stay updated with our latest articles and tech insights</p>
                    <div class="input-group mt-4">
                        <input type="email" class="form-control newsletter-input" placeholder="Your email address">
                        <button class="btn newsletter-btn text-white" type="button">Subscribe</button>
                    </div>
                </div>
            </div>
            <hr class="mt-4 mb-4" style="border-color: rgba(255,255,255,0.1);">
            <div class="row">
                <div class="col-md-6 text-md-start text-center text-white-50">
