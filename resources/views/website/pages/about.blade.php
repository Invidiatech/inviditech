        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 animate">
                    <div class="about-img">
                    <img src="{{ asset('assets/profile/Muhammad Nawaz(Software Enginer)') }}"  alt="Muhammad Nawaz" class="img-fluid rounded">
                    </div>
                </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8 text-white animate">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="https://www.fiverr.com/muhammadnawa564" target="_blank" class="btn btn-accent-custom px-4">Hire Me Now</a>
